...
class ChangePasswordFrame(Frame):
    def __init__(self, parent):
        ...
        self.change_password_button = Button(self, text = "Change Password", width = 15, command = self.change_password_button_click)
    ...
    def change_password_button_click(self):
        ...
        if row is not None:
            ...
            if new_password == confirm_password:
                ...
                con.commit()
                messagebox.showinfo("Success Message", "Your password is changed successfully")
            else:
                messagebox.showerror("Error Message", "New Password and Confirm Password did'nt match")
        else:
